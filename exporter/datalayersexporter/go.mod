module github.com/emqx-ecp-devops/opentelemetry-collector-contrib/exporter/datalayersexporter

go 1.22.0

require (
	github.com/emqx-ecp-devops/influxdb-observability/otel2influx v0.0.0-20241022034337-d2d1a4a0c8e9
